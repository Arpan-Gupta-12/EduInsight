...
def all_students(limit: int = Query(default=500, le=1000)):
    """Full student directory with CGPA, attendance, risk level and SGPA history."""
    return re_engine.get_all_students(limit=limit)
